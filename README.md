...
- [x] ~~一些场景下段首缩进失效（是 typst 的 bug），需手动 `#h(2em)`~~
  - 已在 [#5](https://github.com/AzurIce/bjtu-typst-template/pull/5) 改为使用 `first-line-indent: (amount: 2em, all: true)`，要求 Typst >= 0.13.0。
